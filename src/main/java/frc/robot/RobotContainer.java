...
public class RobotContainer {
  ...
  public void configureAutoCommands() {
    // this.m_chooser.addOption("L2 Link Farside", new FarsideL2Link(s_Swerve,
    // poseEstimator, wrist, arm, leds));
    this.m_chooser.setDefaultOption("L3 stationary",
        new Tuning(s_Swerve, poseEstimator, arm, wrist, leds).getCommand());
    this.m_chooser.addOption("L2 2.5 Farside + Balance",
        new Farside25Balance(s_Swerve, poseEstimator, wrist, arm, leds).getCommand());
    this.m_chooser.addOption("Cable Side L2", new CableSideL2(s_Swerve, poseEstimator, arm, wrist, leds).getCommand());
    this.m_chooser.addOption("centerbalance",
        new CenterChargeStation(s_Swerve, poseEstimator, arm, wrist, leds).getCommand());
    this.m_chooser.addOption("2056 Link", new Link2056(s_Swerve, poseEstimator, wrist, arm, leds).getCommand());
    // this.m_chooser.addOption("Cable Side L3", new CableSideL3(s_Swerve,
    // poseEstimator, arm, wrist, leds));

    // this.m_chooser.addOption("Two cone auto", new TwoConeAuto(s_Swerve,
    // poseEstimator, arm, wrist, leds));
    this.m_chooser.addOption("Cone and Cube L2", new ConeAndCube(s_Swerve,
        poseEstimator, arm, wrist, leds).getCommand());
    // this.m_chooser.addOption("Cone and Cube L3", new ConeAndCubeL3(s_Swerve,
    // poseEstimator, arm, wrist, leds));
    // this.m_chooser.addOption("L2 Cone Charge Station",
    // new L2ChargeStationCone(s_Swerve, poseEstimator, arm, wrist, leds));
    // this.m_chooser.addOption("L3 Cone Farside",
    // new FarsideConeL3(s_Swerve, poseEstimator, arm, wrist, leds));
    // this.m_chooser.addOption("L2 Cone Center Balance",
    // new CenterChargeStation(s_Swerve, poseEstimator, arm, wrist, leds));
    this.m_chooser.addOption("Cone L2 Stationary", new StationaryConeL2(arm, wrist,
        leds).getCommand());
    this.m_chooser.addOption("Cone L3 Stationary", new StationaryConeL3(arm, wrist,
        leds).getCommand());
    this.m_chooser.addOption("Cube L2 Stationary", new StationaryCubeL2(arm, wrist,
        leds).getCommand());
    this.m_chooser.addOption("Cube L3 Stationary", new StationaryCubeL3(arm, wrist,
        leds).getCommand());
